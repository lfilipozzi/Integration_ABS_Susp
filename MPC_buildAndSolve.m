...
%   x_dot = MPC_EOM(x,u,param).
    ...
    methods(Access = protected)
        ...
        function [u, time] = stepImpl(obj,tau_ref,sx_ref,road_prev,Q,R1,R2,P,x)
            % Implement algorithm. 
            ...
            % |    Define constraints     |
            % +---------------------------+
            % Define three constraint depending on the velocity and enforce
...
%             ef = e; % Use same constraint for terminal state.
            ...
            time = [time2-time1;  % Time to solve MPC  
                time1 - time0];     % Time to build solver
        end
        ...
        function [flag, flag1] = isOutputFixedSizeImpl(~)
            flag = true;
            flag1 = true;
        end
